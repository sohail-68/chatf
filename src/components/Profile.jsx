    ...
    const fetchUserData = async () => {
      try {
        const response = await axios.get(
          "https://chatbackendnew-1.onrender.com/api/auth/myprofile",
          {
...
setMessage(response.data.message);
  ...
  const fetchUserProfilUser = async () => {
    try {
      const response = await axios.get(
        `https://chatbackendnew-1.onrender.com/api/userpost/all`,
        {
          headers: {
...
console.log(use);
  ...
  const Count = async () => {
    try {
      const response = await axios.get(
        `https://chatbackendnew-1.onrender.com/api/user/postCount`,
        {
          headers: {
  ...
  const del = async () => {
    ...
    try {
      ...
      const response = await axios.delete(
        `https://chatbackendnew-1.onrender.com/api/auth/users/bookmarks`,
        {
          headers: { Authorization: `${token}` },
        }
      );
